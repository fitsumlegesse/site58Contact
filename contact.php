...
<html lang="en">
 <head>
     <title>(Fitsum Legesse): Responsive Website</title>
  <meta charset="utf-8" />
 ...
 <body>
     <header>
     <h1>Fitsum Legesse</h1>
        <nav class="topnav" id="myTopnav">
            <a href="index.html" class="active">Home</a>
            <a href="http://web-students.net/site58/web150/timeofday/" target="_blank">Time Of Day</a>
            ...
            <a href="https://github.com/fitsumlegesse" target="_blank">GitHub</a>
            <a href="https://www.linkedin.com/in/fitsum-legesse-ab4b3911b/" target="_blank">LinkedIn</a>
...
//            var_dump($_POST);
//            echo '</pre>';   
            $to  = 'fitsumlegesse@icloud.com';//put your email here
     ...
     <footer>
      <p><small>&copy; 2020 by <a href="contact.php">Contact Fitsum </a>, All Rights Reserved ~ <a href="http://validator.w3.org/check/referer" target="_blank">Valid HTML</a> ~ <a href="http://jigsaw.w3.org/css-validator/check?uri=referer" target="_blank">Valid CSS</a></small></p>
    </footer>
  </main>
